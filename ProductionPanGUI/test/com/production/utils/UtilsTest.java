...
public class UtilsTest {
    ...
    public void shouldBuildForTwoTurnsWithPriorities() {
        class X {
            ...
            public X(final int partNumber, final String order) {
            ...
            public String toString() {
                return "X{" + "partNumber=" + partNumber + ", order=" + order + '}';
            }
        ...
        final List<X> xs1 = xs.stream().filter(x -> x.getPartNumber() == 1).collect(Collectors.toList());
        System.out.println(xs1);
        
        final Iterator<X> itxs1 = xs1.iterator();
        while (itxs1.hasNext()) {
            final X x = itxs1.next();
            x.setOrder("El x .... ");
        }
